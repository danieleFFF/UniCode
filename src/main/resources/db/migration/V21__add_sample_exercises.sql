-- Additional Python exercises (id_language = 1)
...
-- Additional Java exercises (id_language = 2)
INSERT INTO exercises (id_language, title, description, difficulty, points, solution_demo) VALUES
...
-- Additional C++ exercises (id_language = 3)
INSERT INTO exercises (id_language, title, description, difficulty, points, solution_demo) VALUES
...
-- Additional JavaScript exercises (id_language = 5)
INSERT INTO exercises (id_language, title, description, difficulty, points, solution_demo) VALUES
...
-- Additional HTML exercises (id_language = 4)
INSERT INTO exercises (id_language, title, description, difficulty, points, solution_demo) VALUES
...
-- Additional SQL exercises (id_language = 6)
INSERT INTO exercises (id_language, title, description, difficulty, points, solution_demo) VALUES
...
-- Test cases for new exercises (using approximate IDs - adjust based on actual inserted IDs)
-- Python exercises test cases
...
-- JavaScript exercises test cases
INSERT INTO test_cases (id_exercise, input, expected_output) VALUES
