...
VALUES
    ...
    (10, 'racecar', 'true'),
    (10, 'hello', 'false'),
    (11, '{"a": 1, "b": {"c": 2}}', '{"a": 1, "b": {"c": 2}}');

INSERT INTO public.test_cases (id_exercise, input, expected_output)
VALUES
    (12, '', 'Valid semantic HTML structure'),
    (13, '', 'Form with proper labels and validation'),
    (14, '', 'Navigation with ARIA attributes');

INSERT INTO public.test_cases (id_exercise, input, expected_output)
VALUES
    (15, '', 'Product with highest order count');
