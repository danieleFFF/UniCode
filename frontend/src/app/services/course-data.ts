...
export class CourseDataService{
  ...
  public getTopics(languageKey:string):Observable<TopicFromDB[]>{
    ...
    return this.http.get<TopicFromDB[]>(`${this.apiUrl}/language/${languageId}`,{withCredentials:true});
  }
  ...
  public getTopic(languageKey:string,topicIndex:number):Observable<TopicFromDB|undefined>{
    ...
    return this.http.get<TopicFromDB[]>(`${this.apiUrl}/language/${languageId}`,{withCredentials:true}).pipe(
      map(topics=>{
